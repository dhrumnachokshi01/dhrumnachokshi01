...
expName = 'Signal detection- oreintation discrimination'  # from the Builder filename that created this script
expInfo = {
...
thisExp = data.ExperimentHandler(name=expName, version='',
    ...
    originPath='F:\\Dhrumna\\Ahmedabad University\\Fourth year\\PSY\\Experiment - IN CLASS\\Signal detection- oreintation discrimination_lastrun.py',
...
trials = data.TrialHandler(nReps=201.0, method='random', 
...
# completed 201.0 repeats of 'trials'
